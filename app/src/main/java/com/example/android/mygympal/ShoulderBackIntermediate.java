...
public class ShoulderBackIntermediate extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_shoulder_back_intermediate);
    }
    public void hiphinge(View v)
    {
        clk=(Button) findViewById(R.id.playhiphinge);
        video=(VideoView)findViewById(R.id.hiphinge);
        video.setVideoPath("android.resource://"+getPackageName()+"/"+R.raw.hiphinge);
        video.start();
    }
    ...
    public void hoverpushups(View v)
    {
        clk=(Button) findViewById(R.id.playhoverpushups);
        video=(VideoView)findViewById(R.id.hoverpushups);
        video.setVideoPath("android.resource://"+getPackageName()+"/"+R.raw.hoverpushups);
        video.start();
    }
